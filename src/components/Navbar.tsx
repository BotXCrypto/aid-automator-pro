      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="text-2xl font-heading font-bold text-primary">ScholarHub</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Button className="bg-gradient-accent hover:bg-gradient-hover transition-all">
              Subscribe
            </Button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-border">
            ...
            <Button className="w-full mt-4 bg-gradient-accent hover:bg-gradient-hover transition-all">
              Subscribe
            </Button>
          </div>
        )}
