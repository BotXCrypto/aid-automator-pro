      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-12">
            Your AI-ready platform for discovering scholarships, education news, and study opportunities worldwide
          </p>
          ...
          <div className="bg-card rounded-2xl shadow-strong p-8 mb-8">
            ...
            <p className="text-foreground mb-4">
              At NextScholar, we believe that financial constraints should never stand in the way of education. 
            ...
            <p className="text-foreground">
              <strong>How AI helps:</strong> Our platform uses advanced AI technology to automatically extract and 
              format scholarship data from multiple sources, ensuring you get the most up-to-date opportunities 
              faster than ever before. This means more time for you to focus on applications and less time searching.
            </p>
          </div>
          ...
          <div className="bg-gradient-hero rounded-2xl shadow-strong p-8 text-white text-center">
            ...
            <p className="text-lg mb-6 opacity-90">
              Subscribe to get the latest scholarship opportunities and education news delivered to your inbox daily
            </p>
